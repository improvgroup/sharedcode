// <copyright file="ServiceCollectionExtensions.cs" company="William Forney">
...
public static class ServiceCollectionExtensions
{
	...
	/// <summary>
	/// Adds registrations to the <paramref name="services" /> collection using conventions
	/// specified using the <paramref name="action" />.
	/// </summary>
