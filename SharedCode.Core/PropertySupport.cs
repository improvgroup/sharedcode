namespace SharedCode
{
	...
	public static class PropertySupport
	{
		...
		/// Thrown when the expression is: <br /> Not a <see cref="MemberExpression" /><br /> The
		/// <see cref="MemberExpression" /> does not represent a property. <br /> Or, the property
		/// is static.
		/// </exception>
		...
		/// </exception>
		/// <exception cref="ArgumentException">
		/// Thrown when the expression is: <br /> The <see cref="MemberExpression" /> does not
		/// represent a property. <br /> Or, the property is static.
		/// </exception>
