namespace SharedCode.Threading.Tasks
{
	...
	{
		/// <summary>
		/// Safely execute the Task without waiting for it to complete before moving to the next
		/// line of code; commonly known as "Fire And Forget". Inspired by John Thiriet's blog post,
