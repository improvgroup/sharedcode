...
namespace SharedCode.Threading.Tasks
{
	...
	{
		/// <summary>
		/// Safely execute the <see cref="ValueTask"/> without waiting for it to complete before moving to the next line of code; commonly known as "Fire And Forget".
		/// </summary>
		...
		/// If an exception is thrown in the <see cref="ValueTask"/>, <c>onException</c> will execute. If onException is null, the exception will be re-thrown.
		/// </param>
		/// <remarks>
