...
public static class StringExtensions
{
	...
	public static string? Fill(this string format, object? arg) =>
	...
	/// <param name="arg">The argument.</param>
	/// <returns>The formatted string.</returns>
	public static string? Fill(this string format, IFormatProvider provider, object? arg) =>
		string.Format(provider, format, arg);
	...
	/// <param name="args">The arguments.</param>
	/// <returns>The formatted string.</returns>
	public static string? Fill(this string format, IFormatProvider provider, params object?[] args) =>
	...
	/// <param name="arg">The argument.</param>
	/// <returns>The formatted string.</returns>
	public static string? FillInvariant(this string format, object? arg) =>
	...
	/// <param name="args">The arguments.</param>
	/// <returns>The formatted string.</returns>
	public static string? FillInvariant(this string format, params object?[] args) =>
	...
	/// <returns>
	/// A copy of format in which the first format item has been replaced by the <see cref="string"
	/// /> equivalent of <paramref name="arg0" />.
	/// </returns>
	public static string? Format(this string? value, object arg0) =>
		value is null
			? null
			: string.Format(CultureInfo.CurrentCulture, value, arg0);
	...
	public static string ToTitleCase(this string value, CultureInfo cultureInfo) =>
		cultureInfo?.TextInfo.ToTitleCase(value) ??
